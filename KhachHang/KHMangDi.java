...
public class KHMangDi extends KhachHang {
    ...
    // Hàm khởi tạo với tên khách hàng, tình trạng thành viên, chi tiết thành viên,
    // địa chỉ (Address)
    public KHMangDi(String customerName, boolean isMember, MemberCard memberCard) {
        super(customerName, isMember, memberCard);
    }

    public KHMangDi(String customerID, String customerName, boolean isMember, MemberCard memberCard) {
    ...
    public void suaThongTin() {
        ...
        loop2: while (true) {
            // System.out.println("\nSửa thông tin khách hàng mang đi có ID: " +
            // this.customerID);
